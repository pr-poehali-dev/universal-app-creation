  ...
  return (
    ...
    >
      <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        {/* Тело */}
        <ellipse cx="50" cy="65" rx="30" ry="35" fill="hsl(var(--duo-primary))" />
        {/* Голова */}
        <circle cx="50" cy="30" r="25" fill="hsl(var(--duo-primary))" />
        {/* Глаза */}
        <circle cx="40" cy="25" r={expression.eyes.rx} ry={expression.eyes.ry} fill="white" />
        <circle cx="60" cy="25" r={expression.eyes.rx} ry={expression.eyes.ry} fill="white" />
        <circle cx="40" cy="25" r="3" fill="black" />
        <circle cx="60" cy="25" r="3" fill="black" />
        {/* Клюв */}
        <polygon points="50,35 40,45 60,45" fill="hsl(var(--duo-beak))" />
        {/* Брови */}
        <rect x="33" y={expression.brows.y} width="14" height={expression.brows.height} fill="hsl(var(--duo-secondary))" rx="2" />
        <rect x="53" y={expression.brows.y} width="14" height={expression.brows.height} fill="hsl(var(--duo-secondary))" rx="2" />
      </svg>
    </div>
  );
};
  ...
  return (
    <div className="absolute top-[20%] left-[45%] opacity-60 float" style={{ animationDelay: delay }}>
      <div className="w-16 h-16">
        <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          {/* Голова */}
          <circle cx="50" cy="50" r="25" fill="hsl(var(--duo-primary))" />
          {/* Глаза */}
          ...
          {/* Клюв */}
          <polygon points="50,55 40,65 60,65" fill="hsl(var(--duo-beak))" />
          {/* Брови */}
          <rect x="33" y="35" width="14" height="4" fill="hsl(var(--duo-secondary))" rx="2" />
          <rect x="53" y="35" width="14" height="4" fill="hsl(var(--duo-secondary))" rx="2" />
        </svg>
      </div>
  ...
  return (
    <div className="absolute bottom-[-5%] left-[10%] w-60 h-60 opacity-80 bounce z-10">
      <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        ...
        <polygon points="50,35 40,45 60,45" fill="hsl(var(--duo-beak))" />
        {/* Брови */}
        <rect x="33" y="15" width="14" height="4" fill="hsl(var(--duo-secondary))" rx="2" />
        <rect x="53" y="15" width="14" height="4" fill="hsl(var(--duo-secondary))" rx="2" />
        {/* Лапки */}
        <ellipse cx="35" cy="90" rx="10" ry="5" fill="hsl(var(--duo-secondary))" />
        <ellipse cx="65" cy="90" rx="10" ry="5" fill="hsl(var(--duo-secondary))" />
      </svg>
    </div>
  );
};
